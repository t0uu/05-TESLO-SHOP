...
interface Props{
 ...
 const SearchPage:NextPage<Props> = ({products,foundProducts,query}) => {
  ...
  {
    foundProducts ?  <Typography variant='h2' sx={{mb: 1}} textTransform="capitalize">Término: {query}</Typography>
    : (
        <Box display='flex'>
...
export const getServerSideProps: GetServerSideProps = async ({params}) => {
    ...
    // usamos let porque puede que la persona busque algun producto y no exista.
